...
private slots:
  ...
  void on_MF_Attack_autopwnButton_clicked(); // 新增的自动攻击按钮

  void on_MF_Attack_rf08sButton_clicked(); // 新增的rf08s卡的攻击按钮
  ...
  void signalInit();
  void MF_widgetReset();
  void setTableItem(QTableWidget *widget, int row, int column,
                    const QString &text);
